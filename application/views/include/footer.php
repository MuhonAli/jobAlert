      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy; <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All Rights Reserved | <i class="icon-heart text-warning" aria-hidden="true"></i> <a href="https://colorlib.com" target="_blank" >Job Alert</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
 ...
 <script>
   $(document).on('click', '#employer-button', function(){

 $(".employer-form").addClass("show-form");
 $(".employee-form").addClass("hide-form");
   });

   $(document).on('click', '#employee-button', function(){

 $(".employer-form").removeClass("show-form");
 $(".employee-form").removeClass("hide-form");
 $(".employee-form").addClass("show-form");
   });
 </script>
  </body>
</html>